...
--
-- Host: localhost:8889
-- Generation Time: Aug 11, 2015 at 03:42 PM
...
(1, 385, 2019, 'שאלה ניסוי 1#1*2$$שאלה ניסוי 2#2*4$$שאלה נוספת בלה בלה#3*4$$שאלה נוספת 3#4*5$$'),
(2, 385, 2019, 'שאלה ניסוי 1#1*2$$שאלה ניסוי 2#2*4$$שאלה נוספת בלה בלה#3*4$$שאלה נוספת 3#4*5$$');
